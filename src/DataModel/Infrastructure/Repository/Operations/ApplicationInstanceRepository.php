...
namespace Swark\DataModel\Infrastructure\Repository\Operations;
...
SELECT
    ...
    ci.scomp_id AS application_instance_scomp_id,
...
LEFT JOIN configuration_item ci ON ai.id = ci.ref_id AND ci.ref_type = 'application_instance'
