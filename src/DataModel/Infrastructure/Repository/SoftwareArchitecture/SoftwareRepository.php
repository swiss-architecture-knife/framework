...
namespace Swark\DataModel\Infrastructure\Repository\SoftwareArchitecture;
...
SELECT
    ...
    ci.scomp_id AS software_scomp_id,
...
FROM
	software sw
LEFT JOIN
	configuration_item ci ON sw.id = ci.ref_id AND ci.ref_type = 'software'
LEFT JOIN
