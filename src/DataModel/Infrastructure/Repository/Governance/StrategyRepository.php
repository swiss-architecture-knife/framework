...
namespace Swark\DataModel\Infrastructure\Repository\Governance;
...
ci.scomp_id AS finding_scomp_id,
...
ci2.scomp_id AS action_scomp_id,
...
LEFT JOIN configuration_item ci ON f.id = ci.ref_id AND ci.ref_type = 'finding'
...
LEFT JOIN configuration_item ci2 ON a.id = ci2.ref_id AND ci2.ref_type = 'action'
