...
use Swark\DataModel\Infrastructure\Eloquent\Model\Governance\Kpi\Kpi;
use Swark\DataModel\Infrastructure\Eloquent\Model\Governance\Kpi\Measurement;
...
class MetricsSheet extends AbstractSwarkExcelSheet implements FromGenerator, WithTitle
{
    ...
    protected function importRow(RowContext $row)
    {
        ...
        $this->compositeKeyContainer->set('metric', $metric->configurationItem->scomp_id, $metric->id);
