...
/**
 * Imports the application instance's resource usages.
 * At the moment, only database schemas are imported.
 */
class ResourceUsagesVirtualSheet extends ApplicationInstancesSheet implements HasPublicTitle
{
    ...
    {
        $this->usesRelationshipType = RelationshipType::upsert('uses',
