...
use Swark\DataModel\InformationTechnology\Infrastructure\UI\Component\BaremetalResource\Pages\CreateBaremetalNic;
use Swark\DataModel\InformationTechnology\Infrastructure\UI\Component\BaremetalResource\Pages\EditBaremetal;
use Swark\DataModel\InformationTechnology\Infrastructure\UI\Component\BaremetalResource\Pages\ManageBaremetalNics;
...
class BaremetalResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\DataModel\InformationTechnology\Infrastructure\UI\Component\BaremetalResource\Pages\ListBaremetals::route('/'),
            'create' => \Swark\DataModel\InformationTechnology\Infrastructure\UI\Component\BaremetalResource\Pages\CreateBaremetal::route('/create'),
            'edit' => \Swark\DataModel\InformationTechnology\Infrastructure\UI\Component\BaremetalResource\Pages\EditBaremetal::route('/{record}/edit'),
