...
use Swark\DataModel\Business\Infrastructure\UI\ActorResource\RelationManagers\ActorOutgoingRelationManager;
...
use Swark\DataModel\Business\Infrastructure\UI\ActorResource\RelationManagers\ZoneRelationManager;
...
class ActorResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\DataModel\Business\Infrastructure\UI\ActorResource\Pages\ListActors::route('/'),
            'create' => \Swark\DataModel\Business\Infrastructure\UI\ActorResource\Pages\CreateActor::route('/create'),
            'edit' => \Swark\DataModel\Business\Infrastructure\UI\ActorResource\Pages\EditActor::route('/{record}/edit'),
        ];
    }
}
