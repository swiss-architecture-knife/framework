...
use Swark\DataModel\Business\UI\OrganizationResource\RelationManagers\AccountsRelationManager;
...
class OrganizationResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\DataModel\Business\UI\OrganizationResource\Pages\ListOrganizations::route('/'),
            'create' => \Swark\DataModel\Business\UI\OrganizationResource\Pages\CreateOrganization::route('/create'),
            'edit' => \Swark\DataModel\Business\UI\OrganizationResource\Pages\EditOrganization::route('/{record}/edit'),
        ];
    }
}
