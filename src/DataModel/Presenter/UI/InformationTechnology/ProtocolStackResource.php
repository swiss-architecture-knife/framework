...
class ProtocolStackResource extends Resource
{
    ...
    {
        return [
            'index' => ProtocolStackResource\Pages\ListProtocolStacks::route('/'),
            'create' => ProtocolStackResource\Pages\CreateProtocolStack::route('/create'),
            'edit' => ProtocolStackResource\Pages\EditProtocolStack::route('/{record}/edit'),
        ];
    }
}
