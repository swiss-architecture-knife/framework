...
use Swark\DataModel\Presenter\UI\InformationTechnology\Component\BaremetalResource\Pages\CreateBaremetal;
use Swark\DataModel\Presenter\UI\InformationTechnology\Component\BaremetalResource\Pages\CreateBaremetalNic;
use Swark\DataModel\Presenter\UI\InformationTechnology\Component\BaremetalResource\Pages\EditBaremetal;
use Swark\DataModel\Presenter\UI\InformationTechnology\Component\BaremetalResource\Pages\ListBaremetals;
use Swark\DataModel\Presenter\UI\InformationTechnology\Component\BaremetalResource\Pages\ManageBaremetalNics;
...
class BaremetalResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return static::decorator($form)
            ->nameHint("You might use the server's serial number or EC2 instance name for this")
            ->sections([
                /*
    ...
    {
        return [
            'index' => ListBaremetals::route('/'),
            'create' => CreateBaremetal::route('/create'),
            'edit' => EditBaremetal::route('/{record}/edit'),
