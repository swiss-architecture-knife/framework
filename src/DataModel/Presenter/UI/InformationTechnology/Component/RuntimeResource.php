...
use Swark\DataModel\Presenter\UI\InformationTechnology\Component\RuntimeResource\Pages\CreateRuntime;
use Swark\DataModel\Presenter\UI\InformationTechnology\Component\RuntimeResource\Pages\EditRuntime;
use Swark\DataModel\Presenter\UI\InformationTechnology\Component\RuntimeResource\Pages\ListRuntimes;
...
class RuntimeResource extends Resource
{
    ...
    {
        return [
            'index' => ListRuntimes::route('/'),
            'create' => CreateRuntime::route('/create'),
            'edit' => EditRuntime::route('/{record}/edit'),
        ];
    }
}
