...
use Swark\DataModel\Presenter\UI\Operations\ApplicationInstanceResource\Pages\CreateApplicationInstance;
use Swark\DataModel\Presenter\UI\Operations\ApplicationInstanceResource\Pages\EditApplicationInstance;
use Swark\DataModel\Presenter\UI\Operations\ApplicationInstanceResource\Pages\ListApplicationInstances;
...
class ApplicationInstanceResource extends Resource
{
    ...
    {
        return [
            'index' => ListApplicationInstances::route('/'),
            'create' => CreateApplicationInstance::route('/create'),
            'edit' => EditApplicationInstance::route('/{record}/edit'),
        ];
    }
}
