...
class ControlResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\DataModel\Compliance\UI\ControlResource\Pages\ListControls::route('/'),
            'create' => \Swark\DataModel\Compliance\UI\ControlResource\Pages\CreateControl::route('/create'),
            'edit' => \Swark\DataModel\Compliance\UI\ControlResource\Pages\EditControl::route('/{record}/edit'),
        ];
    }
}
