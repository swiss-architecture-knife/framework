...
use Swark\DataModel\Compliance\UI\ActionResource\RelationManagers\ActionableControlRelationManager;
use Swark\DataModel\Compliance\UI\ActionResource\RelationManagers\ActionableObjectiveRelationManager;
...
class ActionResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\DataModel\Compliance\UI\ActionResource\Pages\ListActions::route('/'),
            'create' => \Swark\DataModel\Compliance\UI\ActionResource\Pages\CreateAction::route('/create'),
            'edit' => \Swark\DataModel\Compliance\UI\ActionResource\Pages\EditAction::route('/{record}/edit'),
        ];
    }
}
