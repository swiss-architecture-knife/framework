...
class FindingResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\DataModel\Compliance\UI\FindingResource\Pages\ListFindings::route('/'),
            'create' => \Swark\DataModel\Compliance\UI\FindingResource\Pages\CreateFinding::route('/create'),
            'edit' => \Swark\DataModel\Compliance\UI\FindingResource\Pages\EditFinding::route('/{record}/edit'),
        ];
    }
}
