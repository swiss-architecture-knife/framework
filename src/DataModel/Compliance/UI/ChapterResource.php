...
class ChapterResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\DataModel\Compliance\UI\ChapterResource\Pages\ListChapters::route('/'),
            'create' => \Swark\DataModel\Compliance\UI\ChapterResource\Pages\CreateChapter::route('/create'),
            'edit' => \Swark\DataModel\Compliance\UI\ChapterResource\Pages\EditChapter::route('/{record}/edit'),
        ];
    }
}
