...
use App\Management\Resources\Compliance\ChapterResource\Pages;
use App\Management\Resources\Compliance\ChapterResource\RelationManagers;
use Filament\Forms;
...
class ChapterResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\Management\Compliance\Resources\ChapterResource\Pages\ListChapters::route('/'),
            'create' => \Swark\Management\Compliance\Resources\ChapterResource\Pages\CreateChapter::route('/create'),
            'edit' => \Swark\Management\Compliance\Resources\ChapterResource\Pages\EditChapter::route('/{record}/edit'),
        ];
    }
}
