...
use App\Management\Resources\Ecosystem\ProtocolStackResource\Pages;
use App\Management\Resources\Ecosystem\ProtocolStackResource\RelationManagers;
use Filament\Forms;
...
class ProtocolStackResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\Management\Architecture\Resources\Ecosystem\ProtocolStackResource\Pages\ListProtocolStacks::route('/'),
            'create' => \Swark\Management\Architecture\Resources\Ecosystem\ProtocolStackResource\Pages\CreateProtocolStack::route('/create'),
            'edit' => \Swark\Management\Architecture\Resources\Ecosystem\ProtocolStackResource\Pages\EditProtocolStack::route('/{record}/edit'),
        ];
    }
}
