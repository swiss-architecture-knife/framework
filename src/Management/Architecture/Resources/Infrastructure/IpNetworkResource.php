...
class IpNetworkResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\Management\Architecture\Resources\Infrastructure\IpNetworkResource\Pages\ListIpNetworks::route('/'),
            'create' => \Swark\Management\Architecture\Resources\Infrastructure\IpNetworkResource\Pages\CreateIpNetwork::route('/create'),
            'edit' => \Swark\Management\Architecture\Resources\Infrastructure\IpNetworkResource\Pages\EditIpNetwork::route('/{record}/edit'),
        ];
    }
}
