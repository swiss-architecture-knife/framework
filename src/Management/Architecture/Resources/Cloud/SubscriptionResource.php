...
class SubscriptionResource extends Resource
{
    ...
    {
        return [
            'index' => \Swark\Management\Architecture\Resources\Cloud\SubscriptionResource\Pages\ListSubscriptions::route('/'),
            'create' => \Swark\Management\Architecture\Resources\Cloud\SubscriptionResource\Pages\CreateSubscription::route('/create'),
            'edit' => \Swark\Management\Architecture\Resources\Cloud\SubscriptionResource\Pages\EditSubscription::route('/{record}/edit'),
        ];
    }
}
