...
namespace Swark\Frontend\Application\Components;
...
class Plantuml extends Component
{
    ...
    public function render()
    {
        return function (array $data) {
            ...
            $transformer = function (\Swark\Frontend\Application\Components\Diagram\Source $source) use ($enableCache, $id, $doTrimming, $routableComponents) {
                ...
                return new \Swark\Frontend\Application\Components\Diagram\Output(
            ...
            $locator = new \Swark\Frontend\Application\Components\Diagram\Locator(
                fileViewFinder: $this->fileViewFinder,
                transformer: new \Swark\Frontend\Application\Components\Diagram\Transformer($transformer),
